...
meta = [
      ...
      "arguments" : [
        {
          ...
          "example" : [
            "resources/allen_brain_atlas/dataset.h5ad"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
  ...
  "dependencies" : [
    {
      "name" : "dataset_loaders/download_singlecell_broadinstitute_dataset",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "dataset_loaders/infer_truth",
      "repository" : {
        "type" : "local"
      }
    }
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cell_cell_communication/task_cell_cell_communication/src/dataset_loaders/workflow/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/dataset_loaders/workflow",
    "viash_version" : "0.9.0-RC7",
    "git_commit" : "77d16591862b42d2bef78b2621120c4650667c0e",
...
include { download_singlecell_broadinstitute_dataset } from "${meta.resources_dir}/../../../nextflow/dataset_loaders/download_singlecell_broadinstitute_dataset/main.nf"
include { infer_truth } from "${meta.resources_dir}/../../../nextflow/dataset_loaders/infer_truth/main.nf"
