...
meta = [
  ...
  "info" : {
    ...
    "type_info" : {
      ...
      "description" : "This processor infers ground-truth annotations from a spatial dataset and splits it into the single-cell dataset and the ground-truth annotations.\n"
    }
  },
  "status" : "enabled",
  "dependencies" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cell_cell_communication/task_cell_cell_communication/src/data_processors/workflow/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { infer_truth } from "${meta.resources_dir}/../../../nextflow/data_processors/infer_truth/main.nf"
