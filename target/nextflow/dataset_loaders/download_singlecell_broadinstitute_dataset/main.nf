// download_singlecell_broadinstitute_dataset build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cell_cell_communication/task_cell_cell_communication/src/dataset_loaders/download_singlecell_broadinstitute_dataset/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  'dataset_curl_config': $( if [ ! -z ${VIASH_PAR_DATASET_CURL_CONFIG+x} ]; then echo "r'${VIASH_PAR_DATASET_CURL_CONFIG//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cell_cell_communication/dataset_loaders/download_singlecell_broadinstitute_dataset",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
