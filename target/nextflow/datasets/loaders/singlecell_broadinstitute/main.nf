// singlecell_broadinstitute build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cell_cell_communication/task_cell_cell_communication/src/datasets/loaders/singlecell_broadinstitute/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/datasets/loaders/singlecell_broadinstitute",
    "viash_version" : "0.9.0",
...
par = {
  'raw_data_dir': $( if [ ! -z ${VIASH_PAR_RAW_DATA_DIR+x} ]; then echo "r'${VIASH_PAR_RAW_DATA_DIR//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cell_cell_communication/datasets/loaders/singlecell_broadinstitute",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
